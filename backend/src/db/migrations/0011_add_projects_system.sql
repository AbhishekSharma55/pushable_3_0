-- Projects system: new tables + agent/schedule modifications
...
ALTER TABLE "agents" ADD COLUMN IF NOT EXISTS "is_ceo" boolean DEFAULT false NOT NULL;
ALTER TABLE "agents" ADD COLUMN IF NOT EXISTS "agent_type" text DEFAULT 'worker' NOT NULL;

-- New column on schedules
...
ALTER TABLE "projects" ADD CONSTRAINT "projects_created_by_agents_id_fk" FOREIGN KEY ("created_by") REFERENCES "public"."agents"("id") ON DELETE set null ON UPDATE no action;

-- Foreign keys for project_milestones
...
-- Foreign keys for project_agents
...
-- Foreign keys for project_knowledge_bases
...
ALTER TABLE "project_knowledge_bases" ADD CONSTRAINT "project_knowledge_bases_kb_id_knowledge_bases_id_fk" FOREIGN KEY ("kb_id") REFERENCES "public"."knowledge_bases"("id") ON DELETE cascade ON UPDATE no action;
...
-- Foreign keys for run_reports
ALTER TABLE "run_reports" ADD CONSTRAINT "run_reports_workspace_id_workspaces_id_fk" FOREIGN KEY ("workspace_id") REFERENCES "public"."workspaces"("id") ON DELETE cascade ON UPDATE no action;
ALTER TABLE "run_reports" ADD CONSTRAINT "run_reports_agent_id_agents_id_fk" FOREIGN KEY ("agent_id") REFERENCES "public"."agents"("id") ON DELETE cascade ON UPDATE no action;
ALTER TABLE "run_reports" ADD CONSTRAINT "run_reports_project_id_projects_id_fk" FOREIGN KEY ("project_id") REFERENCES "public"."projects"("id") ON DELETE set null ON UPDATE no action;
ALTER TABLE "run_reports" ADD CONSTRAINT "run_reports_session_id_sessions_id_fk" FOREIGN KEY ("session_id") REFERENCES "public"."sessions"("id") ON DELETE set null ON UPDATE no action;
ALTER TABLE "run_reports" ADD CONSTRAINT "run_reports_schedule_id_schedules_id_fk" FOREIGN KEY ("schedule_id") REFERENCES "public"."schedules"("id") ON DELETE set null ON UPDATE no action;

-- Foreign key for schedules.project_id
