export const API_URL = process.env.NEXT_PUBLIC_API_URL || 'https://api.pushable.ai';
export const BROWSER_WS_URL = process.env.NEXT_PUBLIC_BROWSER_WS_URL || 'wss://browser.pushable.ai';
export const TOKEN_KEY = 'pushable_token';
