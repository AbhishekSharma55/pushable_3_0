...
export OPENROUTER_KEY="${OPENROUTER_KEY:-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}"
...
export FRONTEND_URL="${FRONTEND_URL:-https://platform.pushable.ai}"
export NEXT_PUBLIC_API_URL="${NEXT_PUBLIC_API_URL:-https://api.pushable.ai}"
export NEXT_PUBLIC_BROWSER_WS_URL="${NEXT_PUBLIC_BROWSER_WS_URL:-wss://browser.pushable.ai}"
